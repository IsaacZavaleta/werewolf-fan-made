  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: '24px' }}>
        ...
        <div style={{ fontStyle: 'italic', color: 'rgba(245,230,200,.45)', fontSize: '1.25rem' }}>
          Asegúrate de que nadie más vea la pantalla
        </div>
      </div>

      {/* Card flip */}
      <div style={{ perspective: '800px', width: '260px', height: '350px', marginBottom: '36px' }}>
        <button
          ...
          style={{
            ...
            height: '100%',
            cursor: 'pointer',
            /* Preserve 3D en el propio button */
        ...
        >
          ...
          <div style={{
            ...
            <div style={{ fontFamily: "'Cinzel Decorative', serif", fontSize: '.85rem', letterSpacing: '.18em', color: 'rgba(201,168,76,.4)', textTransform: 'uppercase' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ fontFamily: "'Cinzel Decorative', serif", fontSize: '1.25rem', color: role.group === 'wolf' ? '#e05555' : 'var(--gold)', letterSpacing: '.08em' }}>
                {role.name}
              </div>
              <div style={{ fontSize: '1rem', color: 'rgba(245,230,200,.6)', lineHeight: 1.3, textAlign: 'center' }}>
                {role.desc}
              </div>
            </div>
          </div>
